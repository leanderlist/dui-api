...
loop = int(os.environ.get('UPDATE_TIMER'))
...
async def on_message(message):
    if "Bist du online" in message.content:
        await message.channel.send("Ja ich bin online und die Methode on_ready habe ich augenscheinlich auch schon gemacht")
